...
class SimpleAuth {
    ...
    private async handleGameSelection(gameType: string): Promise<void> {
        ...
        try {
            ...
            if (response.ok) {
                this.showStatus(`Starting ${gameType} game...`, 'success');
                // Here you would typically redirect to the game or show game UI
            ...
            this.showStatus('Failed to create game', 'error');
        }
    }
}
